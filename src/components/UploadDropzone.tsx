  ...
  return (
    <Box>
      ...
      >
        ...
        {isDragActive ? (
          <Box>
            <DocumentUpload size={48} color="var(--mui-palette-primary-main)" style={{ marginBottom: 16 }} />
          ...
          <Box>
            <DocumentUpload size={48} color="var(--mui-palette-text-secondary)" style={{ marginBottom: 16 }} />
